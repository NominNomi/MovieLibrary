...
namespace MovieLibrary {
    ...
    interface iMovie
    {
        ...
        override string ToString(); //return a string containning the title, genre, classification, duration, and the number of copies of this movie currently in the community library 
